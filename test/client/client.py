...
class Client:
    def __init__(self, parent=None):
        ...
        if len(os.listdir('../../test/client/friend_id')) == 0:
        ...
        if not os.path.exists('private'):
            ...
            with shelve.open(os.path.join('../../test/client/friend_id', os.listdir('friend_id')[0])) as file:
        ...
        # Обработчики кнопок
        keyboard.add_hotkey('Ctrl + 1', self.connect_server)
        keyboard.add_hotkey('Ctrl + 2',self.send_message)
        keyboard.add_hotkey('Ctrl + 3',self.generate_encrypt)
        keyboard.add_hotkey('Ctrl + 1',self.clear_panel)
